...
_mainEngine.OnPageLoaded += _mainEngine_OnPageLoaded;
        ...
        public void OnMouseEnterOverride()
        {
        ...
        public void OnMouseExitOverride()
        {
            _focused = true;
            if (UIEnabled)
                mainUIPanel.Show();
        ...
        public void OnMouseDownOverride(BaseEventData data)
        {
            PointerEventData eventData = (PointerEventData)data;

            if (_mainEngine.Initialized)
            {
                Vector2 pixelUV = PointerPositionInRect(eventData.position);
        ...
        public void OnMouseUpOverride(BaseEventData data)
        {
            PointerEventData eventData = (PointerEventData)data;
